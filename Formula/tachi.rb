class Tachi < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kckylechen1/homebrew-tachi/releases/download/tachi-1.9.1/tachi-v1.9.1-aarch64-apple-darwin.tar.gz"
      sha256 "e9e6993e2316464495037d37bdae09f63ccc65eb4a3bf78ae79731b083af5237"
    end
    on_intel do
